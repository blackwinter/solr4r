...
Gem::Specification.new do |s|
  ...
  s.files = ["COPYING", "ChangeLog", "README", "Rakefile", "TODO", "lib/solr4r.rb", "lib/solr4r/builder.rb", "lib/solr4r/client.rb", "lib/solr4r/document.rb", "lib/solr4r/request.rb", "lib/solr4r/request_extension.rb", "lib/solr4r/response.rb", "lib/solr4r/result.rb", "lib/solr4r/uri_extension.rb", "lib/solr4r/version.rb", "spec/solr4r/builder_spec.rb", "spec/spec_helper.rb"]
  ...
  s.rdoc_options = ["--title", "solr4r Application documentation (v0.0.3)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
